            ...
            <div className="row justify-content-center">
                <div className="col-md-10">
                    <div className=" border-0">
                        ...
                        <h3 className="heading">Getting to Dhamma Pattana</h3>
                        <div className="mb-3">
                            <p className="mb-0"><strong>Dhamma Pattana Vipassana Centre</strong></p>
                            <p className="lead mb-0">Inside Global Vipassana Pagoda Campus</p>
                            <p className="lead mb-0">Next to Esselworld, Gorai Village,</p>
                            <p className="lead mb-0">Borivali (West), Mumbai 400091</p>
                        </div>
                        <p className="lead">
